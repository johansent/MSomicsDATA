...
#' }
#' @source See details of \code{\link{MSomicsDATA}} for relevant grant numbers. Data is also available on MassIVE (massive.ucsd.edu) with dataset id MSV000079154.
#' @rdname lipid_edata
#' @name lipid_edata
NULL
...
#'
#' @format A lipidData object (see \code{\link[MSomicsQC]{as.lipidData}} for details)
#' \describe{
...
#' }
#' @source See details of \code{\link{MSomicsDATA}} for relevant grant numbers. Data is also available on MassIVE (massive.ucsd.edu) with dataset id MSV000079154.
#' @rdname lipid_lipidData
#' @name lipid_lipidData
NULL
...
#' }
#' @source See details of \code{\link{MSomicsDATA}} for relevant grant numbers. Data is also available on MassIVE (massive.ucsd.edu) with dataset id MSV000079153.
#' @rdname metab_edata
#' @name metab_edata
NULL
...
#'
#' An S3 object of class metabData (see \code{\link[MSomicsQC]{as.metabData}} for details)
#'
...
#' }
#' @source See details of \code{\link{MSomicsDATA}} for relevant grant numbers. Data is also available on MassIVE (massive.ucsd.edu) with dataset id MSV000079153.
#' @rdname metab_metabData
#' @name metab_metabData
NULL
...
#' }
#' @source See details of \code{\link{MSomicsDATA}} for relevant grant numbers. Data is also available on MassIVE (massive.ucsd.edu) with dataset id MSV000079152.
#' @rdname pep_edata
#' @name pep_edata
NULL
...
#'
#' An S3 object of class pepData (see \code{\link[MSomicsQC]{as.pepData}} for details)
#'
...
#'   \item{Infection*}{Eight columns of infection samples}
#' }
#' @source See details of \code{\link{MSomicsDATA}} for relevant grant numbers.
...
#'
#' An S3 object of class proData (see \code{\link[MSomicsQC]{as.proData}} for details)
#'
